            ...
            <nav class="s-header__nav-wrap">
                ...
                <ul class="s-header__nav">
                    ...
                    <li class="has-children">
                        ...
                        <ul class="sub-menu">
                            <li><a href="{{ route ('pages', 'category') }}">Design</a></li>
                            <li><a href="{{ route ('pages', 'category') }}">Lifestyle</a></li>
                            <li><a href="{{ route ('pages', 'category') }}">Photography</a></li>
                            <li><a href="{{ route ('pages', 'category') }}">Vacation</a></li>
                            <li><a href="{{ route ('pages', 'category') }}">Work</a></li>
                            <li><a href="{{ route ('pages', 'category') }}">Health</a></li>
                            <li><a href="{{ route ('pages', 'category') }}">Family</a></li>
                            <li><a href="{{ route ('pages', 'category') }}">Relationship</a></li>
                        </ul>
                    </li>
                    <li class="has-children">
                        <a href="#0" title="">Blog</a>
                        <ul class="sub-menu">
                            <li><a href="{{ route ('pages', 'single-video') }}">Video Post</a></li>
                            <li><a href="{{ route ('pages', 'single-audio') }}">Audio Post</a></li>
                            <li><a href="{{ route ('pages', 'single-standard') }}">Standard Post</a></li>
                        </ul>
                    </li>
                    <li><a href="{{ route ('pages', 'styles') }}" title="">Styles</a></li>
                    <li><a href="{{ route ('pages', 'about') }}" title="">About</a></li>
                    <li class="current"><a href="{{ route ('pages', 'contact') }}" title="">Contact</a></li>
