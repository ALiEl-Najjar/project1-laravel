                        ...
                        <div class="entry__thumb">
                            <a href="single-standard.html" class="thumb-link">
                                <img src="{{ asset('images/thumbs/masonry/macbook-600.jpg') }}" 
                                     srcset="{{ asset('images/thumbs/masonry/macbook-600.jpg 1x') }},
                                     {{ asset('images/thumbs/masonry/macbook-1200.jpg 2x') }}" alt="">
                            </a>
                        ...
                        <div class="entry__thumb">
                            <a href="single-standard.html" class="thumb-link">
                                <img src="{{ asset('images/thumbs/masonry/woodcraft-600.jpg') }}" 
                                     srcset="{{ asset('images/thumbs/masonry/woodcraft-600.jpg 1x') }},
                                     {{ asset('images/thumbs/masonry/woodcraft-1200.jpg 2x') }}" alt="">
                            </a>
                        </div> <!-- end entry__thumb -->
                        ...
                        <div class="entry__thumb">
                            <a href="single-standard.html" class="thumb-link">
                                <img src="{{ asset('images/thumbs/masonry/tulips-600.jpg') }}" 
                                     srcset="{{ asset('images/thumbs/masonry/tulips-600.jpg 1x') }},
                                     {{ asset('images/thumbs/masonry/tulips-1200.jpg 2x') }}" alt="">
                            </a>
                        </div>  <!-- end entry__thumb -->
                        ...
                        <div class="entry__thumb">
                            <a href="single-standard.html" class="thumb-link">
                                <img src="{{ asset('images/thumbs/masonry/grayscale-600.jpg') }}" 
                                     srcset="{{ asset('images/thumbs/masonry/grayscale-600.jpg 1x') }},
                                     {{ asset('images/thumbs/masonry/grayscale-1200.jpg 2x') }}" alt="">
                            </a>
                        </div> <!-- end entry__thumb -->
                        ...
                        <div class="entry__thumb">
                            <a href="single-standard.html" class="thumb-link">
                                <img src="{{ asset('images/thumbs/masonry/walk-600.jpg') }}" 
                                     srcset="{{ asset('images/thumbs/masonry/walk-600.jpg 1x') }},
                                     {{ asset('images/thumbs/masonry/walk-1200.jpg 2x') }}" alt="">
                            </a>
                        </div> <!-- end entry__thumb -->
                        ...
                        <div class="entry__thumb">
                            <a href="single-standard.html" class="thumb-link">
                                <img src="{{ asset('images/thumbs/masonry/jump-600.jpg') }}" 
                                     srcset="{{ asset('images/thumbs/masonry/jump-600.jpg 1x') }},
                                     {{ asset('images/thumbs/masonry/jump-1200.jpg 2x') }}" alt="">
                            </a>
                        </div> <!-- end entry__thumb -->
                        ...
                        <div class="entry__thumb">
                            <a href="single-standard.html" class="thumb-link">
                                <img src="{{ asset('images/thumbs/masonry/real-600.jpg') }}" 
                                     srcset="{{ asset('images/thumbs/masonry/real-600.jpg 1x') }},
                                     {{ asset('images/thumbs/masonry/real-1200.jpg 2x') }}" alt="">
                            </a>
                        </div> <!-- end entry__thumb -->
                        ...
                        <div class="entry__thumb">
                            <a href="single-standard.html" class="thumb-link">
                                <img src="{{ asset('images/thumbs/masonry/lamp-600.jpg') }}" 
                                     srcset="{{ asset('images/thumbs/masonry/lamp-600.jpg 1x') }},
                                     {{ asset('images/thumbs/masonry/lamp-1200.jpg 2x') }}" alt="">
                            </a>
                        </div> <!-- end entry__thumb -->
                        ...
                        <div class="entry__thumb">
                            <a href="single-standard.html" class="thumb-link">
                                <img src="{{ asset('images/thumbs/masonry/clock-600.jpg') }}" 
                                     srcset="{{ asset('images/thumbs/masonry/clock-600.jpg 1x') }},
                                     {{ asset('images/thumbs/masonry/clock-1200.jpg 2x') }}" alt="">
                            </a>
                        </div> <!-- end entry__thumb -->
                        ...
                        <div class="entry__thumb">
                            <a href="single-standard.html" class="thumb-link">
                                <img src="{{ asset('images/thumbs/masonry/beetle-600.jpg') }}" 
                                     srcset="{{ asset('images/thumbs/masonry/beetle-600.jpg 1x') }},
                                     {{ asset('images/thumbs/masonry/beetle-1200.jpg 2x') }}" alt="">
                            </a>
                        </div> <!-- end entry__thumb -->
                        ...
                        <div class="entry__thumb">
                            <a href="single-standard.html" class="thumb-link">
                                <img src="{{ asset('images/thumbs/masonry/phone-and-keyboard-600.jpg') }}" 
                                     srcset="{{ asset('images/thumbs/masonry/phone-and-keyboard-600.jpg 1x') }},
                                     {{ asset('images/thumbs/masonry/phone-and-keyboard-1200.jpg 2x') }}" alt="">
                            </a>
                        </div> <!-- end entry__thumb -->
                        ...
                        <div class="entry__thumb">
                            <a href="single-standard.html" class="thumb-link">
                                <img src="{{ asset('images/thumbs/masonry/seashore-600.jpg') }}" 
                                     srcset="{{ asset('images/thumbs/masonry/seashore-600.jpg 1x') }},
                                     {{ asset('images/thumbs/masonry/seashore-1200.jpg 2x') }}" alt="">
                            </a>
                        </div> <!-- end entry__thumb -->
