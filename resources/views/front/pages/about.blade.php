                ...
                <article class="s-content__entry">
                    ...
                    <div class="s-content__media">
                        <img src="{{ asset('images/thumbs/about/about-1050.jpg') }}" 
                                srcset="{{ asset('images/thumbs/about/about-2100.jpg 2100w') }}, 
                                {{ asset('images/thumbs/about/about-1050.jpg 1050w') }}, 
                                {{ asset('images/thumbs/about/about-525.jpg 525w') }}" sizes="(max-width: 2100px) 100vw, 2100px" alt="">
